...
public class FuturisticcarsModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		FuturisticcarsMod.addNetworkMessage(SavedDataSyncMessage.TYPE, SavedDataSyncMessage.STREAM_CODEC, SavedDataSyncMessage::handleData);
	}
	...
	public static class WorldVariables extends SavedData {
		public static final String DATA_NAME = "futuristiccars_worldvars";
	...
	public static class MapVariables extends SavedData {
		public static final String DATA_NAME = "futuristiccars_mapvars";
		public double normalcar = 0;
		...
		public void read(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			normalcar = nbt.getDouble("normalcar");
		}

		@Override
		public CompoundTag save(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			nbt.putDouble("normalcar", normalcar);
			return nbt;
		}
	...
	public record SavedDataSyncMessage(int dataType, SavedData data) implements CustomPacketPayload {
		public static final Type<SavedDataSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(FuturisticcarsMod.MODID, "saved_data_sync"));
