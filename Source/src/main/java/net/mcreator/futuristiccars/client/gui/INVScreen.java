...
public class INVScreen extends AbstractContainerScreen<INVMenu> {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("futuristiccars:textures/screens/inv.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.futuristiccars.inv.label_cars_fuel"), 55, 19, -12829636, false);
	}
