	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world instanceof Level _level) {
			if (!_level.isClientSide()) {
				_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("futuristiccars:flyingcar")), SoundSource.NEUTRAL, (float) 0.08, 1);
			} else {
				_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("futuristiccars:flyingcar")), SoundSource.NEUTRAL, (float) 0.08, 1, false);
			}
		}
		if (entity.isVehicle()) {
